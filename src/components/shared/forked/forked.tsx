...
export class ForkedIconComponent extends React.Component {
  constructor(props: any) {
    super(props);
    this.state = {
      forked: this.props.children
    }
  }
  render() {
    return (
      <a className="forked-icon-component mr-3" href={this.state['forked']['networkUrl']} target="_blank">
